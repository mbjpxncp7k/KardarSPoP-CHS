...
\section{熵}
	...
	\begin{enumerate}
		...
		\end{equation}
		% Graphics
		\item 我们可以用\ref{eq:1.25}构造出另一个状态函数，\termIntroduce{熵}$S$。由于该积分与路径无关而仅依赖于两端点，我们可设定
		...
		这在力学上的类比是：在表面上放置一个质点，而重力提供着一个向下的力，随着各种约束被移除，粒子将在\shortRadicalTranslation{高度更低的位置}{locations of decreasing height}安定下来。因此，有关熵增的说法并不比观察到物体在重力作用下倾向于下落这事更神秘！
	\end{enumerate}
